        ...
        <main class="centered">
            <div class="grid-two">
                ...
                <form class="form-u card" method="POST" action="#" autocomplete="off">
                    ...
                    <input type="text" id="uArea" name="uArea" placeholder="Ingrese area..." value="<?= $uArea ?>"
                           oninput="CheckUsersFormButton();">
                    <div class="united">
                        ...
                        <input type="email" id="uEmail" name="uEmail" placeholder="Ingrese email..." value="<?= $uEmail ?>"
                               oninput="CheckUsersFormButton();">
                        <input type="tel" id="uNumber" name="uNumber" placeholder="Ingrese telefono..." value="<?= $uNumber ?>" 
