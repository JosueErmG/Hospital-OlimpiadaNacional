...
<?php
    ...
    if ($DTh == 0) {
        ...
        $curPage = isset($_POST["dt_curPage"]) ? max(1, min($_POST["dt_curPage"], $totalPages)) : 1;
        ...
        <main class="centered">
            <div class="grid-two">
                            ...
                            <table>
                                ...
                                <?php foreach($rows as $row) { ?>
                                    <tr class="datatable_drow" id="datatable_row_<?= $row['ID'] ?>">
                                        ...
                                        <?php } ?>
                                        <?php if ($_SESSION["user"][7] or $_SESSION["user"][0] == $row['usuarioLegajo']) { ?>
                ...
                <form class="form-u card" method="POST" action="#" autocomplete="off">
                    ...
                    <textarea type="text" id="hData" name="hData" placeholder="Ingrese datos medicos..."
